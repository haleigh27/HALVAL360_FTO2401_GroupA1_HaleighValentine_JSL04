...
console.log(`Cans left: ${cansLeft}. ${cansLeft < 5 ? `Time to restock!` : `We're stocked!`}`);
...
console.log(`Heart Rate: ${heartRate} bpm. ${heartRate < 100 ? `Boost needed!` : `Energy levels are high!`}`);
...
console.log(`Current Temperature: ${currentTemp}°C. ${currentTemp <= 5 ? `Chilled to perfection!` : `Needs a cooler!`}`);
...
console.log(`Current Hour: ${currentHour}. ${currentHour > 7 && currentHour < 24 ? `Unleash the beast!` : `Better stick to water!`}`);
